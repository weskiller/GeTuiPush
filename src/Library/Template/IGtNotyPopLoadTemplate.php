...
use Weskiller\GeTuiPush\Library\Button;
use Weskiller\GeTuiPush\Library\InnerFiled;
use Weskiller\GeTuiPush\Library\InnerFiledType;
...
class IGtNotyPopLoadTemplate extends IGtBaseTemplate {
	 ...
	 * 通知是否可清楚
	 */
	protected $isCleared = true;
	/**
	 * 是否响铃
	 */
	protected $isBelled = true;
	/**
	 * 是否震动
	 */
	protected $isVibrationed = true;
	 ...
	 * 是否自动安装
	 */
	protected $isAutoInstall = false;
	/**
	 * 是否激活
	 */
	protected $isActived = false;

    protected $symbianMark="";
    protected $androidMark="";
    protected $iosMark="";
	protected $notifyStyle = 0;
